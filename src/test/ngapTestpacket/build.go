...
// define a function to fetch RAN gNB MNC and MCC "\x02\xf8\x39"
...
func getbuildDataBuildFromMongoDB() (string, []byte, []byte, []byte, []byte, []byte) {
	...
	var slice_sst = stringToByteArray(buildDatainstance.Snssai_sst)
	var slice_sd = stringToByteArray(buildDatainstance.Snssai_sd)
	var gNBId = stringToByteArray(buildDatainstance.GNBId)

	// fmt.Println("********************************************************************:", aper.OctetString(plmnid))

	return rannnodeName, plmnid, tac, slice_sst, slice_sd, gNBId
}



func init() {
	var _, plmnidFrombuildDB, _, _ , _ , _ = getbuildDataBuildFromMongoDB()
	TestPlmn.Value = aper.OctetString(plmnidFrombuildDB)
}

func BuildNGSetupRequest() (pdu ngapType.NGAPPDU) {

	// var plmnidFrombuildDB = "\x02\xf8\x39"
	var rannnodeNameFrombuildDB, plmnidFrombuildDB, tacFrombuildDB, sstFrombuildDB, sdFrombuildDB, gNBIdFrombuildDB  = getbuildDataBuildFromMongoDB()
	...
	globalGNBID.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
	...
	*gNBID = aper.BitString{
	...
	rANNodeName.Value = rannnodeNameFrombuildDB
	nGSetupRequestIEs.List = append(nGSetupRequestIEs.List, ie)
	// SupportedTAList
	ie = ngapType.NGSetupRequestIEs{}
	...
	supportedTAItem.TAC.Value = aper.OctetString(tacFrombuildDB)
	...
	broadcastPLMNItem.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
	...
	sliceSupportItem.SNSSAI.SST.Value = aper.OctetString(sstFrombuildDB)
	// optional
	sliceSupportItem.SNSSAI.SD = new(ngapType.SD)
	// sliceSupportItem.SNSSAI.SD.Value = aper.OctetString("\x01\x02\x03")
	sliceSupportItem.SNSSAI.SD.Value = aper.OctetString(sdFrombuildDB)
...
func BuildInitialUEMessage(ranUeNgapID int64, nasPdu []byte, fiveGSTmsi string) (pdu ngapType.NGAPPDU) {
	...
	var _, _, tacFrombuildDB, _, _, _  = getbuildDataBuildFromMongoDB()
	...
	userLocationInformationNR.TAI.TAC.Value = aper.OctetString(tacFrombuildDB)
...
func BuildUEContextReleaseComplete(amfUeNgapID, ranUeNgapID int64, pduSessionIDList []int64) (pdu ngapType.NGAPPDU) {
	...
	userLocationInformationNR := userLocationInformation.UserLocationInformationNR
	userLocationInformationNR.NRCGI.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
	userLocationInformationNR.NRCGI.NRCellIdentity.Value = aper.BitString{
		Bytes:     []byte{0x00, 0x00, 0x00, 0x00, 0x10},
		BitLength: 36,
	}

	userLocationInformationNR.TAI.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
...
func BuildUEContextModificationResponse(amfUeNgapID, ranUeNgapID int64) (pdu ngapType.NGAPPDU) {
	...
	locationNR.NRCGI.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
	locationNR.NRCGI.NRCellIdentity.Value = aper.BitString{
		Bytes:     []byte{0x00, 0x00, 0x00, 0x00, 0x10},
		BitLength: 36,
	}

	locationNR.TAI.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
...
func BuildUplinkNasTransport(amfUeNgapID, ranUeNgapID int64, nasPdu []byte) (pdu ngapType.NGAPPDU) {
	...
	var _, plmnidFrombuildDB, tacFrombuildDB , _ , _  , _ = getbuildDataBuildFromMongoDB()
...
func BuildRanConfigurationUpdate() (pdu ngapType.NGAPPDU) {
	...
	var rannnodeNameFrombuildDB, _, tacFrombuildDB, _ , _ , _  = getbuildDataBuildFromMongoDB()
...
func BuildUplinkRanConfigurationTransfer() (pdu ngapType.NGAPPDU) {
	...
	targetRANNodeID.GlobalRANNodeID.GlobalGNBID.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
	...
	*gNBID = aper.BitString{
	...
	targetRANNodeID.SelectedTAI.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
	// targetRANNodeID.SelectedTAI.TAC.Value = aper.OctetString("\x00\x00\x01")
	targetRANNodeID.SelectedTAI.TAC.Value = aper.OctetString(tacFrombuildDB)
	...
	sourceRANNodeID.GlobalRANNodeID.GlobalGNBID.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
	...
	*gNBID = aper.BitString{
	...
	sourceRANNodeID.SelectedTAI.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
	// sourceRANNodeID.SelectedTAI.TAC.Value = aper.OctetString("\x00\x00\x01")
	sourceRANNodeID.SelectedTAI.TAC.Value = aper.OctetString(tacFrombuildDB)
...
func BuildLocationReport() (pdu ngapType.NGAPPDU) {
	...
	areaOfInterestRANNodeItem.GlobalRANNodeID.GlobalGNBID.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
...
func BuildHandoverRequired(
	...
	globalRANNodeID.GlobalGNBID.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
...
func BuildCellTrafficTrace(amfUeNgapID, ranUeNgapID int64) (pdu ngapType.NGAPPDU) {
	...
	nGRANCGI.NRCGI.PLMNIdentity.Value = aper.OctetString(plmnidFrombuildDB)
